// Service parameters
OSMO_SV_insptime = 10; // (seconds) The time it takes for service men to inspect vehicle
OSMO_SV_fueltime = 80; // (seconds) The time it takes for for completely empty fueltank to be refueled into full
OSMO_SV_hpfixtime = 3; // (seconds) The time it takes for service men to fix each fully damaged hitpoint
