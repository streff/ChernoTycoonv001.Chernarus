...
_towns = [elektro_office, balota_airfield, kamyshovo_bus, prigo_farm, solnichniy, green_mountain_station, tulgaWest, devilsCastle, lopatino_factory, NW_airfield];
...
_punterGroup setGroupId ["Air Passengers"];
